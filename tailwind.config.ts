...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display':   ['60px', { lineHeight: '1.05', letterSpacing: '-2px',   fontWeight: '800' }],
        'h1':        ['40px', { lineHeight: '1.1',  letterSpacing: '-1.5px', fontWeight: '800' }],
        'h2':        ['28px', { lineHeight: '1.2',  letterSpacing: '-1px',   fontWeight: '700' }],
